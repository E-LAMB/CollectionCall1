...
public class Enemy_AI_Photographer : MonoBehaviour
{

    public float moving_speed;
    public float normal_speed = 7f;
    public float rushing_speed = 15f;
    public float rushing_max_time = 10f;
    public float rushing_time = 0f;
    ...
    public void AlertedToLocation(float knowledge_time)
    {
    ...
    void Update()
    {
        ...
        if (rushing_time > 0f)
        {
            moving_speed = rushing_speed;
        } else
        {   
            moving_speed = normal_speed;
        }
